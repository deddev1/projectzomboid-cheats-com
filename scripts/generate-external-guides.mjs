...
const GAME_PROFILES = {
	...
	'escape-from-tarkov': {
		...
		beginnerTip: 'Run offline mode to learn extracts and common horde spawn angles before risking expensive kits.',
		midgameTip: 'Memorize ammo penetration values — the right round beats a more expensive gun with the wrong ammo.',
		advancedTip: 'Time raids around quest hotspots and boss horde spawns, but rotate routes when server traffic spikes.',
	...
	'unturned': {
		...
		beginnerTip: 'Pick a base near water and a military horde spawn, but not directly on a main road.',
	...
	'battlefield': {
		...
		beginnerTip: 'Play support or engineer first to learn horde spawn flow and resupply timing.',
	...
	'call-of-duty-warzone': {
		...
		advancedTip: 'Track gas movement and self-revive inventory during horde clusters; placement beats ego challs.',
	...
	'the-isle': {
		...
		coreLoop: 'horde spawn as a dinosaur, hunt or graze to grow, and survive apex predators and rival packs',
	...
	'dayz': {
		...
		beginnerTip: 'Move inland quickly — coast horde spawns are crowded and low on reliable gear.',
	...
	'once-human': {
		...
		advancedTip: 'Plan territory horde defenses around resource nodes your guild actually needs.',
		metaNote: 'Seasonal modifiers shift viable builds — read patch notes before investing materials.',
		communityAngle: 'Guilds split gathering, crafting, and PvP horde defense during territory wars.',
	},
	'marvel-rivals': {
		genre: 'hero team shooter',
		...
		midgameTip: 'Trigger team-up abilities during objective contests, not during staggered rehorde spawns.',
		advancedTip: 'Track enemy ultimate economy and play defensively when multiple ults are available.',
		metaNote: 'Objective time and rehorde spawn stagger win close matches on most maps.',
	...
	'call-of-duty': {
		...
		advancedTip: 'Pre-aim common angles and use horde spawn knowledge to control mid-map fights.',
	...
	'the-front': {
		...
		communityAngle: 'Clans rotate online horde defense and raid squads across time zones.',
	},
	'lost-ark': {
		genre: 'action MMORPG',
	...
	'project-zomboid': {
		genre: 'isometric zombie survival sandbox',
		hook: 'Knox County loot routes, infection management, and base defense',
		coreLoop: 'scavenge towns, manage hunger and injuries, fortify a safehouse, and survive escalating horde pressure',
		beginnerTip: 'Pick a quiet spawn town and learn one loot loop before exploring high-risk areas like Louisville.',
		midgameTip: 'Invest in carpentry, farming, and rain collectors early — self-sufficiency beats repeated loot runs.',
		advancedTip: 'Plan generator fuel, alarm schedules, and escape routes before your first large horde night.',
		metaNote: 'Noise and light attract zombies — stealth movement wins more than combat in the early weeks.',
		communityAngle: 'Co-op groups split scavenging, base building, and perimeter watch for safer long-term survival.',
	},
	'ark-survival-ascended': {
		genre: 'open-world dinosaur survival remaster',
		hook: 'tribe progression, taming chains, and biome-specific threats',
		coreLoop: 'gather resources, tame creatures, build bases, and advance through tech tiers across dangerous maps',
		beginnerTip: 'Start on a beginner-friendly map and tame a berry gatherer before pushing into predator territory.',
		midgameTip: 'Secure a metal base location near rich resource nodes — relocation costs spike mid-progression.',
		advancedTip: 'Breeding stat lines and imprint timers create long-term power spikes beyond simple leveling.',
		metaNote: 'Tribe diplomacy and offline raid windows define PvP server survival more than solo combat stats.',
		communityAngle: 'Tribes assign tamers, builders, and fighters during boss fights and resource pushes.',
	},
	'warframe': {
		genre: 'sci-fi action looter shooter',
		hook: 'modding, void fissures, and steel path progression',
		coreLoop: 'complete missions, collect mods and parts, craft Warframes, and scale into endgame activities',
		beginnerTip: 'Clear the star chart and unlock core frames before chasing prime farming or riven markets.',
		midgameTip: 'Build ability strength or range based on your frame role — hybrid builds often underperform.',
		advancedTip: 'Farm relics efficiently in groups and target vaulted primes during double-reward events.',
		metaNote: 'Ability uptime and armor-stripping mechanics define steel path and arbitration viability.',
		communityAngle: 'Squads assign crowd control and damage roles for fissure and survival runs.',
	},
	'dune-awakening': {
		genre: 'open-world survival on Arrakis',
		hook: 'spice harvesting, sandworm threats, and faction conflict',
		coreLoop: 'survive harsh desert conditions, craft gear, navigate storms, and compete for spice and territory',
		beginnerTip: 'Learn stillsuit management and shelter timing before pushing deep into open desert.',
		midgameTip: 'Stock water, filters, and repair kits — sandstorm rotations punish underprepared expeditions.',
		advancedTip: 'Listen for worm vibrations and avoid rhythmic movement on open dunes during high-value routes.',
		metaNote: 'Verticality and ornithopter mobility change engagement ranges more than raw weapon stats.',
		communityAngle: 'Crews coordinate spice runs with spotters, haulers, and rear-guard escorts.',
	},
	'wuthering-waves': {
		genre: 'open-world action RPG with resonator combat',
		hook: 'echo builds, exploration pacing, and resonance chains',
		coreLoop: 'explore regions, recruit resonators, upgrade echoes, and clear story and challenge content',
		beginnerTip: 'Focus on one main DPS resonator and support before spreading upgrade materials thin.',
		midgameTip: 'Build echo sets around your carry\'s damage type — set bonuses outperform scattered five-stars early.',
		advancedTip: 'Plan daily stamina around weekly bosses and weapon ascension materials to avoid progression stalls.',
		metaNote: 'Resonance chains and intro/outro windows matter as much as raw crit ratios in endgame.',
		communityAngle: 'Co-op bosses are smoother when one player handles break and another focuses burst windows.',
	},
	'combat-master': {
		genre: 'fast-paced mobile-style FPS on PC',
		hook: 'movement tech, loadout tuning, and ranked climb',
		coreLoop: 'win gunfights across small maps, unlock attachments, and climb ranked with consistent aim and movement',
		beginnerTip: 'Use low-recoil loadouts until slide and jump-shot timing feels automatic.',
		midgameTip: 'Pre-aim common lanes and spawn flip routes — map flow wins more fights than raw flick aim.',
		advancedTip: 'Track enemy streaks and ult charge timing to avoid pushing during power spikes.',
		metaNote: 'TTK and movement speed shift with patches — verify balance notes before ranked sessions.',
		communityAngle: 'Trios with defined entry and support roles convert mid-map spawns consistently.',
	},
	'foxhole': {
		genre: 'persistent online war sandbox',
		hook: 'logistics chains, front-line pushes, and player-driven economy',
		coreLoop: 'gather resources, manufacture supplies, and push or defend territory in large-scale faction wars',
		beginnerTip: 'Start as a rifleman or medic to learn respawn, supply, and comms basics before specialized roles.',
		midgameTip: 'Run logistics before front-line combat — wars are won by supply lines, not solo hero pushes.',
		advancedTip: 'Coordinate tech progression with faction leadership; wasted components stall entire offensives.',
		metaNote: 'Map reading and safe routing beat combat stats for logi players.',
		communityAngle: 'Regiments split mining, factory work, and assault squads across war phases.',
	},
	'exoborne': {
		genre: 'extraction shooter in a catastrophic future Earth',
		hook: 'dynamic weather, faction gear, and high-risk extractions',
		coreLoop: 'deploy into hostile zones, complete objectives, loot advanced gear, and extract before storms or rivals close in',
		beginnerTip: 'Learn one extraction route per map and practice silent movement before chasing rare loot.',
		midgameTip: 'Balance mobility and sustain — overcommitting during storms leaves you exposed on open ground.',
		advancedTip: 'Track weather timers and rival audio cues before pushing contested extraction windows.',
		metaNote: 'Sound discipline and cover usage matter more than raw DPS in most mid-range fights.',
		communityAngle: 'Squads assign overwatch and carrier roles to survive last-minute extraction pushes.',
	},
	'nba-2k26': {
		genre: 'basketball simulation with online modes',
		hook: 'build optimization, badge layouts, and MyTeam economy',
		coreLoop: 'create builds, earn badges, and compete in Park, Rec, and MyTeam across seasonal content',
		beginnerTip: 'Follow a proven build template before spending VC on experimental stat spreads.',
		midgameTip: 'Prioritize badges that match your playstyle — icon badges outperform scattered bronze perks.',
		advancedTip: 'Study defensive positioning and stamina management; elite players win through spacing, not only stats.',
		metaNote: 'Patch notes shift meta builds each season — re-test before ranked Pro-Am or MyTeam runs.',
		communityAngle: 'Fixed squads with defined positions and callouts climb Rec faster than random queues.',
	},
	'team-fortress-2': {
		genre: 'class-based team shooter',
		hook: 'class roles, payload pushes, and item economy',
		coreLoop: 'play distinct classes, capture objectives, and coordinate pushes across casual and competitive modes',
		beginnerTip: 'Learn one generalist class per role — soldier, scout, medic — before niche picks.',
		midgameTip: 'Communicate uber advantage and push timing — winning fights off cooldowns defines payload rounds.',
		advancedTip: 'Track enemy spy and sniper patterns; awareness wins more than mechanical aim in pub matches.',
		metaNote: 'Team composition and map control beat individual kill counts on most objective modes.',
		communityAngle: 'Six-stack comms with medic tracking and spy checking dominate organized lobbies.',
	},
	'enlisted': {
		genre: 'WWII combined arms squad shooter',
		hook: 'squad orders, vehicle call-ins, and historical loadouts',
		coreLoop: 'lead or follow squads through large battles, capture points, and call reinforcements or vehicles',
		beginnerTip: 'Follow squad orders and stay near your officer — lone wolves die without reinforcement points.',
		midgameTip: 'Swap soldier classes to fill squad gaps; anti-tank and engineer picks swing armor-heavy matches.',
		advancedTip: 'Time vehicle and artillery call-ins with coordinated pushes, not isolated flanks.',
		metaNote: 'Map knowledge and spawn timing matter more than K/D in most conquest scenarios.',
		communityAngle: 'Full squads with voice comms and role discipline flip sectors faster than random groups.',
	},
	'scum': {
		genre: 'hardcore open-world survival sim',
		hook: 'metabolism, skill progression, and brutal PvP',
		coreLoop: 'survive harsh conditions, build skills, loot military zones, and manage base security across wipes',
		beginnerTip: 'Learn nutrition and hydration systems early — ignoring metabolism ends runs silently.',
		midgameTip: 'Train weapon skills through repetition; recoil control improves with in-game practice, not just gear.',
		advancedTip: 'Scout player traffic around bunkers and events; third parties dominate high-tier loot zones.',
		metaNote: 'Sound carries far — slow movement and prone crawls win more fights than sprinting into towns.',
		communityAngle: 'Groups assign hunters, builders, and base guards during offline windows.',
	},
	'grounded': {
		genre: 'survival adventure shrunk to backyard scale',
		hook: 'base blueprints, insect tiers, and co-op dungeon runs',
		coreLoop: 'gather resources, craft armor and weapons, build bases, and progress through backyard biomes',
		beginnerTip: 'Complete the tutorial labs and unlock analyzers before pushing into spider territories.',
		midgameTip: 'Build vertical bases with zip lines — mobility saves time more than extra storage early on.',
		advancedTip: 'Prepare elemental resistances and consumables before boss fights; type advantages matter.',
		metaNote: 'Shared world progression rewards coordinated material farming over solo hoarding.',
		communityAngle: 'Co-op groups split base building, resource runs, and boss prep for faster unlocks.',
	},
	'dota-2': {
		genre: 'competitive MOBA',
		hook: 'draft strategy, lane equilibrium, and objective timing',
		coreLoop: 'draft heroes, win lanes, secure Roshan and towers, and destroy the ancient through team fights',
		beginnerTip: 'Learn one simple support and one core hero before expanding your pool.',
		midgameTip: 'Track enemy missing calls and ward high-traffic runes — vision wins more fights than solo picks.',
		advancedTip: 'Smoke and timing pushes around Roshan and buyback status, not random mid-lane brawls.',
		metaNote: 'Draft synergy and lane assignments define pub success more than individual MMR streaks.',
		communityAngle: 'Five-stacks with standardized drafts and comms climb faster than solo queue chaos.',
	},
	'civilization-vi': {
		genre: 'turn-based 4X strategy',
		hook: 'district planning, civic trees, and victory path pivots',
		coreLoop: 'expand cities, research tech and civics, negotiate with AI, and pursue domination, science, culture, or religion wins',
		beginnerTip: 'Pick a beginner-friendly civ and focus one victory type for your first full game.',
		midgameTip: 'Plan districts around adjacency bonuses — early placement beats reactive building.',
		advancedTip: 'Track AI agendas and war timing; diplomatic surprises stall science and culture victories.',
		metaNote: 'Map settings and disaster modes shift optimal strategies — read setup before committing.',
		communityAngle: 'Multiplayer groups coordinate war declarations and wonder races through voice planning.',
	},
	'enshrouded': {
		genre: 'survival action RPG in a corrupted fantasy world',
		hook: 'glider traversal, base building, and shroud timers',
		coreLoop: 'explore shroud zones, craft gear, expand your base, and defeat bosses to unlock new biomes',
		beginnerTip: 'Extend shroud timer upgrades before deep runs — getting caught mid-route is costly.',
		midgameTip: 'Invest in base crafting stations and storage; centralized industry accelerates all progression.',
		advancedTip: 'Prepare elemental resistances and food buffs before boss attempts; mechanics gate more than DPS.',
		metaNote: 'Co-op scaling rewards balanced roles — tank, ranged DPS, and support sustain longer fights.',
		communityAngle: 'Groups split base duty and expedition teams to keep shroud pushes continuous.',
	},
	'fragpunk': {
		genre: 'hero tactical shooter with shard modifiers',
		hook: 'round-based shard cards, ability combos, and site executes',
		coreLoop: 'win rounds through gunplay and shard effects, adapt strats each round, and execute site takes',
		beginnerTip: 'Learn two lancers with complementary kits before chasing high-skill duelists.',
		midgameTip: 'Read shard picks each round and adjust buys — economy rounds punish predictable rushes.',
		advancedTip: 'Track enemy shard synergies and play post-plant with utility instead of ego peeks.',
		metaNote: 'Shard variety shifts win conditions every round; flexibility beats one-trick strats.',
		communityAngle: 'Five-stacks with standardized callouts and shard planning convert close halves.',
	},
	'raft': {
