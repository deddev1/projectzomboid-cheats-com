...
const KW = {
	...
	checkout: 'Zadeyo',
	eac: 'Project Zomboid anti-cheat',
};
...
export const phrases = {
	es: {
		...
		legal: () => 'Contacta support@projectzomboidcheats.com para solicitudes legales o de soporte.',
	},
	fr: {
		...
		legal: () => 'Contactez support@projectzomboidcheats.com pour le support ou les demandes légales.',
	},
	de: {
		...
		legal: () => 'support@projectzomboidcheats.com für Support und rechtliche Anfragen.',
	},
	pt: {
		buy: 'Comprar Project Zomboid Cheats', undetected: 'indetectáveis', maps: 'loot objectives, zombie horde spawn routes, and loot objectives',
		...
		legal: () => 'Contacte support@projectzomboidcheats.com para suporte ou questões legais.',
	},
	it: {
		buy: 'Acquista Project Zomboid Cheats', undetected: 'indetectable', maps: 'loot objectives, zombie horde spawn routes, and loot objectives',
		...
		legal: () => 'Contatta support@projectzomboidcheats.com per supporto o richieste legali.',
	},
	nl: {
		buy: 'Project Zomboid Cheats kopen', undetected: 'undetected', maps: 'loot objectives, zombie horde spawn routes, and loot objectives',
		...
		legal: () => 'support@projectzomboidcheats.com voor support en juridische vragen.',
	},
	pl: {
		buy: 'Kup Project Zomboid Cheats', undetected: 'undetected', maps: 'loot objectives, zombie horde spawn routes, and loot objectives',
		...
		legal: () => 'support@projectzomboidcheats.com w sprawach wsparcia i prawnych.',
	},
	ru: {
		buy: 'Купить Project Zomboid Cheats', undetected: 'undetected', maps: 'loot objectives, zombie horde spawn routes, and loot objectives',
		...
		legal: () => 'support@projectzomboidcheats.com для поддержки и юридических вопросов.',
	},
	tr: {
		buy: 'Project Zomboid Cheats satın al', undetected: 'undetected', maps: 'loot objectives, zombie horde spawn routes, and loot objectives',
		...
		legal: () => 'Destek ve yasal sorular için support@projectzomboidcheats.com.',
	},
	ar: {
		buy: 'اشترِ Project Zomboid Cheats', undetected: 'غير مكتشف', maps: 'loot objectives, zombie horde spawn routes, and loot objectives',
		...
		legal: () => 'support@projectzomboidcheats.com للدعم والطلبات القانونية.',
	},
	ja: {
		buy: 'Project Zomboid Cheatsを購入', undetected: 'undetected', maps: 'loot objectives, zombie horde spawn routes, and loot objectives',
		...
		legal: () => 'サポート・法務: support@projectzomboidcheats.com',
	},
	ko: {
		buy: 'Project Zomboid Cheats 구매', undetected: 'undetected', maps: 'loot objectives, zombie horde spawn routes, and loot objectives',
		...
		legal: () => '지원 및 법무: support@projectzomboidcheats.com',
	},
	zh: {
		buy: '购买 Project Zomboid Cheats', undetected: 'undetected', maps: 'loot objectives, zombie horde spawn routes, and loot objectives',
		...
		legal: () => '支持与法务：support@projectzomboidcheats.com',
	},
	hi: {
		buy: 'Project Zomboid Cheats खरीदें', undetected: 'undetected', maps: 'loot objectives, zombie horde spawn routes, and loot objectives',
		...
		legal: () => 'सहायता: support@projectzomboidcheats.com',
	},
	id: {
		buy: 'Beli Project Zomboid Cheats', undetected: 'undetected', maps: 'loot objectives, zombie horde spawn routes, and loot objectives',
		...
		legal: () => 'support@projectzomboidcheats.com untuk dukungan dan legal.',
	},
	th: {
		buy: 'ซื้อ Project Zomboid Cheats', undetected: 'undetected', maps: 'loot objectives, zombie horde spawn routes, and loot objectives',
		...
		legal: () => 'support@projectzomboidcheats.com สำหรับการสนับสนุน',
	},
	vi: {
		buy: 'Mua Project Zomboid Cheats', undetected: 'undetected', maps: 'loot objectives, zombie horde spawn routes, and loot objectives',
		...
		legal: () => 'support@projectzomboidcheats.com cho hỗ trợ và pháp lý.',
	},
	uk: {
		buy: 'Купити Project Zomboid Cheats', undetected: 'undetected', maps: 'loot objectives, zombie horde spawn routes, and loot objectives',
		...
		legal: () => 'support@projectzomboidcheats.com для підтримки та правових питань.',
	},
	cs: {
		buy: 'Koupit Project Zomboid Cheats', undetected: 'undetected', maps: 'loot objectives, zombie horde spawn routes, and loot objectives',
		...
		legal: () => 'support@projectzomboidcheats.com pro podporu a právní dotazy.',
	},
	ro: {
		buy: 'Cumpără Project Zomboid Cheats', undetected: 'undetected', maps: 'loot objectives, zombie horde spawn routes, and loot objectives',
		...
		legal: () => 'support@projectzomboidcheats.com pentru suport și legal.',
	},
	sv: {
		buy: 'Köp Project Zomboid Cheats', undetected: 'undetected', maps: 'loot objectives, zombie horde spawn routes, and loot objectives',
		...
		legal: () => 'support@projectzomboidcheats.com för support och juridik.',
	},
};
