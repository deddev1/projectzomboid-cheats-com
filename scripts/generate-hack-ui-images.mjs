 ...
 * Not combat stock photos — product/HUD visuals for Project Zomboid Cheats SEO filenames.
 */
...
const ASSETS = {
	'zomboid-cheats-hero.webp': heroSvg,
	'project-zomboid-cheats-cover.webp': coverSvg,
	'zomboid-esp-overlay.webp': espSvg,
	'project-zomboid-aimbot-ui.webp': aimbotSvg,
	'project-zomboid-wallhack-ui.webp': wallhackSvg,
	'project-zomboid-cheats-menu.webp': menuSvg,
	'project-zomboid-cheats-status.webp': statusSvg,
	'project-zomboid-radar-ui.webp': radarSvg,
	'project-zomboid-soft-aim-ui.webp': softAimSvg,
	'project-zomboid-cheats-panel.webp': panelSvg,
	'project-zomboid-cheats-dashboard.webp': dashboardSvg,
	'project-zomboid-cheats-logo.webp': null, // derived from hero
};
...
function heroSvg() {
  ...
  <text x="120" y="292" fill="#fff" font-family="Segoe UI, Arial, sans-serif" font-size="20" font-weight="700">BUY Project Zomboid Cheats</text>
...
function coverSvg() {
	return frame(
		'Project Zomboid Cheats PACKAGE',
		`
  <rect x="200" y="180" width="1200" height="520" rx="16" fill="url(#panel)" stroke="#c4784055" stroke-width="2"/>
  <text x="260" y="300" fill="#f2ebe3" font-family="Segoe UI, Arial, sans-serif" font-size="72" font-weight="800">Project Zomboid Cheats</text>
...
function statusSvg() {
  ...
  <text x="560" y="520" fill="#d4a574" font-family="Consolas, monospace" font-size="16">Project Zomboid Cheats · status panel</text>`,
	);
}
...
function dashboardSvg() {
  ...
  <text x="120" y="190" fill="#f2ebe3" font-family="Segoe UI, Arial, sans-serif" font-size="28" font-weight="700">Project Zomboid Cheats dashboard</text>
...
for (const [file, factory] of Object.entries(ASSETS)) {
	...
	if (file === 'zomboid-cheats-hero.webp') heroBuf = buf;
}

if (heroBuf) {
	const logo = await sharp(heroBuf).extract({ left: 860, top: 140, width: 512, height: 512 }).resize(512, 512).webp({ quality: 88 }).toBuffer();
	await writeFile(path.join(imagesDir, 'project-zomboid-cheats-logo.webp'), logo);
	...
	console.log('Wrote project-zomboid-cheats-logo.webp + favicons');
}
